...
my (@vars,$fmt);
   ...
   push @vars, $masked_ref->{non_tally};          $fmt.=field(5);   # HMC add
   push @vars, $masked_field_ids->{resrc};        $fmt.=field(6);   # HMC add
   push @vars, $masked_ref->{resrc};              $fmt.=field(5);   # HMC add
   ...
   push @vars, $masked_ref->{cofhe};              $fmt.=field(50);
   push @vars, $masked_field_ids->{cofhe_eth};    $fmt.=field(6);
   push @vars, $masked_ref->{cofhe_eth};          $fmt.=field(50);
